            ...
            <div class="bg-border">
                ...
                <div class="search-box">
                    ...
                    <div class="search-box_div search_box_div_left">
                        <button type="button"  class="search-btn search-btn-chaxu" onclick="searchList('#tableProjectInOutRepayList')">
...
<!--正文-->
        <div class="bg-white">
            <div class="bg-border">
                ...
                <div class="tabled_one">
                    <!--表格-->
                    <table id="tableProjectInOutRepayList"></table>
                    <!--底部翻页按钮栏 -->
		         	<div id="pagerProjectInOutRepayList"></div>
    ...
    <div id="Item_Inoutput_Received" class="add_Makeuup">
        ...
        <div class="main_edge">
            ...
            <div class="tabled_datum_940">
	            <div class="tabled_one">
	                <!--表格-->
	                <table id="tableProjectInOutRepayDetailList"></table>
	                <!--底部翻页按钮栏 -->
	       			<div id="pagerProjectInOutRepayDetailList"></div>
	            </div>
            </div>
        </div>
    </div>
	...
	<script type="text/javascript" src="<%=path %>/pages/count/js/project_inoutput_repay.js"></script>
</body>
</html>