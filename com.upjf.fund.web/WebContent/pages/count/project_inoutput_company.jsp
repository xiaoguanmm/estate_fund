...
<title><c:if test="${intoType eq 1 }">股东公司</c:if><c:if test="${intoType eq 2 }">投入产出项目信息</c:if></title>
    ...
    <div class="bg-gray">
        ...
        <div class="bg-white">
            <div class="bg-border">
           		...
           		<input type="hidden" name="stockholderId" id="stockholderId" value="${stockholderId }"/>
                <div class="search-box">
                    ...
                    <div class="search-box_div search_box_div_left">
                        <button type="button"  class="search-btn search-btn-chaxu" onclick="searchList('#tableProjectInOutCompanyList')">
        ...
        <div class="bg-white">
            <div class="bg-border">
                <div class="title-head">
                    ...
                    <span><c:if test="${intoType eq 1 }">股东公司</c:if><c:if test="${intoType eq 2 }">投入产出项目信息</c:if></span>
                    <a href="javascript:history.go(-1);" title="关闭" class="history_page">关闭</a>
                </div>
                <div class="tabled_one">
                    <!--表格-->
                    <table id="tableProjectInOutCompanyList"></table>
                    <!--底部翻页按钮栏 -->
		         	<div id="pagerProjectInOutCompanyList"></div>
                </div>
            </div>
        </div>

    </div>
	<script type="text/javascript" src="<%=path %>/pages/count/js/project_inoutput_company.js"></script>
</body>
</html>