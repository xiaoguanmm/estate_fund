...
<body>
    <div class="bg-gray">
        ...
        <div class="bg-white">
            <div class="bg-border">
                <form action="<%=path %>/report/stockholderInOutFormPage" method="post" id="searchFrom" name="searchFrom" >
...
<!--正文-->
        <div class="bg-white">
            <div class="bg-border">
                <div class="title-head">
                    ...
                    <a href="<%=path %>/report/stockholderInOutListPage;" title="关闭" class="history_page">关闭</a>
                </div>
    ...
    <div style="display: none" id="stockholderNameList">${stockholderNameList }</div>
	...
	<script type="text/javascript" src="<%=path %>/pages/count/js/stockholder_inoutput_form.js"></script>
</body>
</html>