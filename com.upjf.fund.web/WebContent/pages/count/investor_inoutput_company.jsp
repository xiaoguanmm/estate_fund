    ...
    <div class="bg-gray">
        ...
        <div class="bg-white">
            <div class="bg-border">
           		...
           		<input type="hidden" name="investorId" id="investorId" value="${investorId }"/>
                <div class="search-box">
                    ...
                    <div class="search-box_div">
                        ...
                        <div class="search-text layui-form">
	                        <select name="investSubId" lay-verify="" lay-search="">
	                        	<option value="">-请选择-</option>
                    ...
                    <div class="search-box_div search_box_div_left">
                        <button type="button"  class="search-btn search-btn-chaxu" onclick="searchList('#tableInvestorInOutCompanyList')">
        ...
        <div class="bg-white">
            <div class="bg-border">
                ...
                <div class="tabled_one">
                    <!--表格-->
                    <table id="tableInvestorInOutCompanyList"></table>
                    <!--底部翻页按钮栏 -->
		         	<div id="pagerInvestorInOutCompanyList"></div>
                </div>
            </div>
        </div>

    </div>
	<script type="text/javascript" src="<%=path %>/pages/count/js/investor_inoutput_company.js"></script>
</body>
</html>