...
<body>
    <div class="bg-gray">
        ...
        <div class="bg-white">
            <div class="bg-border">
                <form action="<%=path %>/report/projectInOutFormPage" method="post" id="searchFrom" name="searchFrom" >
...
<!--正文-->
        <div class="bg-white">
            <div class="bg-border">
                <div class="title-head">
                    ...
                    <span>项目投入产出--柱状图</span>
                    <a href="<%=path %>/report/projectInOutListPage;" title="关闭" class="history_page">关闭</a>
                </div>
    ...
    <div style="display: none" id="projectNameList">${projectNameList }</div>
	...
	<script type="text/javascript" src="<%=path %>/pages/count/js/project_inoutput_form.js"></script>
</body>
</html>