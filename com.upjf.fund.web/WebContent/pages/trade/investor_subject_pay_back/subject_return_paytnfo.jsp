...
<!--正文-->
        <div class="bg-white">
            <div class="bg-border">
                <div class="title-head">
                    ...
                    <span>查看回款记录</span>
                    <span class="title-head_red">深圳市融鑫资产管理有限公司</span>
                    <a href="javascript:history.go(-1);" title="关闭" class="history_page">关闭</a>
                </div>
                <div class="top_btn">
                    <a href="javascript:void(0)" class="main_btn" id="Subject_Return_Detailed1">
    ...
    <!--查看回款明细 -弹窗-开始-->
    <div id="Subject_Return_Detailed" class="add_Makeuup">
        <div>
            <div>
