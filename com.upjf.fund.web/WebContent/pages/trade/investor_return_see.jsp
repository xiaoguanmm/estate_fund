...
<!--正文-->
        <div class="bg-white">
            <div class="bg-border">
                <div class="title-head">
                    ...
                    <span>查看回款记录</span>
                    <span class="title-head_red">XXX公司</span>
                    <a href="javascript:history.go(-1);" title="关闭" class="history_page">关闭</a>
                </div>
                <div class="top_btn">
                    <a href="javascript:void(0)" class="main_btn" id="Investor_Return_Add1">
                        <img src="../img/add.png">
                        <span>新增回款记录</span>
                    </a>
                    <a href="javascript:void(0)" class="main_btn" id="Investor_Return_Modify1">
                        <img src="../img/chance.png">
                        <span>修改回款记录</span>
                    </a>
                    <a href="javascript:void(0)" class="main_btn" id="Investor_Return_Detailed1">
                    ...
                    <div class="tabled_two">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <th>回款时间</th><th>回款账号</th><th>项目名称</th><th>付款公司</th><th>回款本金(万元)</th><th>回款利润(万元)</th><th>回款备注</th><th>回款录入人</th><th>回款录入时间</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
                                <td><input type="checkbox" class="hook_inp"></td>
                                <td>2018-07-13</td><td>123566中国银行深圳宝安支行</td><td>南山项目</td><td>深圳市汇联资管二十三号投资管理合伙企业</td><td>15000.00</td><td>5000.00</td><td>回款备注</td><td>admin</td><td>2018-07-13 10:10:10</td>
                            </tr>
                            <tr>
                                <td><input type="checkbox" class="hook_inp"></td>
                                <td>2018-07-13</td><td>123566中国银行深圳宝安支行</td><td>南山项目</td><td>深圳市汇联资管二十三号投资管理合伙企业</td><td>15000.00</td><td>5000.00</td><td>回款备注</td><td>admin</td><td>2018-07-13 10:10:10</td>
                            ...
                            <tr>
                                <td><input type="checkbox" class="hook_inp"></td>
                                <td>2018-07-13</td><td>123566中国银行深圳宝安支行</td><td>南山项目</td><td>深圳市汇联资管二十三号投资管理合伙企业</td><td>15000.00</td><td>5000.00</td><td>--</td><td>admin</td><td>2018-07-13 10:10:10</td>
                            </tr>
                            <tr>
                                <td><input type="checkbox" class="hook_inp"></td>
                                <td>2018-07-13</td><td>123566中国银行深圳宝安支行</td><td>南山项目</td><td>深圳市汇联资管二十三号投资管理合伙企业</td><td>15000.00</td><td>5000.00</td><td>--</td><td>admin</td><td>2018-07-13 10:10:10</td>
    ...
    <!--查看回款明细 -弹窗-开始-->
    <div id="Investor_Return_Detailed" class="add_Makeuup">
        <div>
            <div>
    ...
    <!--新增回款记录 -弹窗-开始-->
    <div id="Investor_Return_Add" class="add_Makeuup">
        <div>
            <div>
                <div class="fillbox_inline">
                    <label class="user-name product-modify-span"><span class="textmust">*</span>项目名称：</label>
