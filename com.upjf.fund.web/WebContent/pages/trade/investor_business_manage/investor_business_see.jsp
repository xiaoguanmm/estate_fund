                        ...
                        <div class="tab-pane active" id="busine_Informaed">
                            <div class="main_edge">
                                <div class="fillbox-left">
                                    <div>
                                    	<input type="text" hidden="hidden" id="investSubjectPid" value="${investor.investor_id}" />
                                    ...
                                    <div>
                                        <div class="fillbox_inline" >
                                            ...
                                            <div class="fillin layui_input_block layui-form">
                                                <input type="radio" name="huilian" value="1" title="是" disabled="disabled"  <c:if test="${investor.is_huilian_corp == '1'}">checked</c:if> />
                                                <input type="radio" name="huilian" value="0" title="否" disabled="disabled"  <c:if test="${investor.is_huilian_corp != '1'}">checked</c:if> />
                                            </div>
                                        </div>
                                        <div class="fillbox_inline" >
