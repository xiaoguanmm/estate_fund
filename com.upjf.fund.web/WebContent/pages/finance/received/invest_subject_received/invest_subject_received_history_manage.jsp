...
<title>投资主体回款历史记录列表</title>
    <%@ include file="../../../../common/common.jsp"%>
    <link href="${basePath}pages/finance/invest/css/invest.css" rel="stylesheet">
    <script type="text/javascript">
		$(function(){
			var url = basePath+"finance/queryInvestSubjectHistoryPaybackList?prjId=${project_id}&receiverId=${receiver_id}&contributiveId=${contributive_id}&receivedType=2"
        ...
        <div class="bg-white">
            <div class="bg-border">
               ...
               <div id="payback_operation" class="add_Makeuup">
                <input type="hidden" id="uploadFileUrl" value="${basePath}finance/uploadInvestSubjectPaybackAccessory">
                <input type="hidden" id="showFileListUrl" value="${basePath}finance/queryInvestSubjectPaybackAccessoryList">
                <input type="hidden" id="delPaybackUrl" value="${basePath}finance/delInvestSubjectPaybackRecord">
                <input type="hidden" id="exportUrl" value="${basePath}finance/exportInvestSubjectHistoryPaybackData">
                ...
                <form id="investForm" action="${basePath}finance/addInvestSubjectPaybackRecord" method="post">
                	...
                	<!-- 回款类别 -->
                	<input type="hidden" class="hide_field" id="receivedType" name="receivedType" value="2">
                    <div class="main_edge">
