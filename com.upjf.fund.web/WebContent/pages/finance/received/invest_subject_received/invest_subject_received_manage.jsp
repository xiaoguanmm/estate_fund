    ...
    <script type="text/javascript">
		$(function(){
			...
			$("#payback").on("click",function(){
				...
				window.location.href = basePath+"finance/toInvestSubjectHistoryPaybackList?project_id="+project_id+
...
<!--正文-->
        <div class="bg-white">
            <div class="bg-border">
                ...
                <div class="top_btn">
                	<input type="hidden" id="exportUrl" value="${basePath}finance/exportInvestSubjectPaybackData">
