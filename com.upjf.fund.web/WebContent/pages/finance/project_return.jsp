...
<body>
    <div class="bg-gray">
        ...
        <div class="bg-white">
            <div class="bg-border">
            	<form action="<%=path %>/finance/exportProjectReturnList" method="post" id="searchFrom" name="searchFrom" > 
                <div class="search-box">
                    ...
                    <div class="search-box_div">
                        ...
                        <div class="search-text">
                            <ul class="search-text_inline">
                                <li>
                                    <input type="text" class="layui-input" id="returnStartDate" name="returnStartDate" lay-key="5">
                                </li>
                                <li>
                                    <img src="<%=path %>/common/img/pay_time.png">
                                </li>
                                <li>
                                    <input type="text" class="layui-input" id="returnEndDate" name="returnEndDate" lay-key="6">
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="search-box_div search_box_div_left" style="width: 500px">
                        <button type="button"  class="search-btn search-btn-chaxu" onclick="searchList('#tableProjectReturnList')">
        ...
        <div class="bg-white">
            <div class="bg-border">
                ...
                <div class="tabled_one">
                    <!--表格-->
                    <table id="tableProjectReturnList"></table>
                    <!--底部翻页按钮栏 -->
		         	<div id="pagerProjectReturnList"></div>
                </div>
            </div>
        </div>

    </div>
<script type="text/javascript" src="<%=path %>/pages/finance/js/project_return.js"></script>
</body>
</html>