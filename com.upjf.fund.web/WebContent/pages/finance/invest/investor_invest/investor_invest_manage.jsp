...
<title>投资人出资管理</title>
    ...
    <script type="text/javascript">
		$(function(){
			var url = basePath+"finance/queryInvestorInvestList?paymentType=3"
			var colNames = ["付款时间","项目名称","股东公司","出资主体","付款账号","付款期数",
			                "付款金额(万元)","收款公司","收款账号",
			                "付款备注","付款凭证","财务录入操作者","录入时间","pid","project_status","stockholder_id"];
			var colModel = [
...
<!--正文-->
        <div class="bg-white">
            <div class="bg-border">
                ...
                <div class="top_btn">
                	<input type="hidden" id="addOperationUrl" value="${basePath}finance/toAddInvestorInvest?operation=add">
	                <input type="hidden" id="modifiyOperationUrl" value="${basePath}finance/toAddInvestorInvest?operation=modify">
	                <input type="hidden" id="viewOperationUrl" value="${basePath}finance/toAddInvestorInvest?operation=view">
	                <input type="hidden" id="deleteOperationUrl" value="${basePath}finance/delInvestorPaymentRecord?operation=delete">
