...
<title>投资主体付款请求</title>
	...
	layui.use(['laydate','form','jquery'],function(){
		...
		function init(){
			...
			loadReceiverCorp(prjId,receiverId);
			/*根据收款公司和项目公司异步加载出资主体(关联资管计划表)*/
			loadInvestSubject(prjId,receiverId,contributiveId);
			/*加载收款银行信息*/
		...
		validator.validate($("#investForm"), function(dom){
			...
			uploadFiles($("#selectFileButton"), $("#fileList"), $("#uploadFileButton"),$("#data_list"), basePath+"finance/uploadInvestSubjectPaymentAccessory",data);
...
<!--正文-->
        <div class="bg-white">
            <div class="bg-border">
                ...
                <form id="investForm" action="${basePath}finance/addInvestSubjectInvest" method="post">
                	<input type="hidden" id="pid" name="pid" value="${payment.pid}">
                	<input type="hidden" id="investType" name="investType" value="2">
                	<input type="hidden" id="stockholderId" name="stockholderId" value="${payment.stockholderId}">
                    <div class="main_edge">
