            ...
            <div class="bg-border">
                ...
                <div class="myTab_content_one">
                        ...
                        <div class="fillbox-left">
                                    ...
                                    <div class="fillin-inputlay">
                                        <form class="layui-form" action="">
                                            <select lay-verify="" lay-search>
                                                ...
                                                <option value="02">深圳市融鑫有限公司</option>
                                            </select>
                                        </form>
                                    </div>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="fillbox_inline">
                                    ...
                                    <div class="fillin">
                                        <input type="text" value="266546456" class="fillin-input">
                                    </div>
                                </div>
                            </div>
                            <div>
                            ...
                            <div>
                                <div class="fillbox_inline">
                                    <label class="user-name product-modify-span"><span class="textmust">*</span>收款金额：</label>
                                    <div class="fillin">
                            ...
                            <div>
                                <div class="fillbox_inline ">
                                    ...
                                    <div class="fillin">
                                        <textarea class="fillin-input tarea_remarks"></textarea>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="btn_edge btn_edge_left">
                        <a href="share_provide.html" class="btn_cancel btn_all">
