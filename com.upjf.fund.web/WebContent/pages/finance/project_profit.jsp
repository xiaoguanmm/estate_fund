...
<body>
    <div class="bg-gray">
        ...
        <div class="bg-white">
            <div class="bg-border">
                <form action="<%=path %>/finance/exportProjectProfitList" method="post" id="searchFrom" name="searchFrom" > 
                <div class="search-box">
                    ...
                    <div class="search-box_div search_box_div_left" style="width: 500px">
                        <button type="button"  class="search-btn search-btn-chaxu" onclick="searchList('#tableProjectProfitList')">
        ...
        <div class="bg-white">
            <div class="bg-border">
                ...
                <div class="tabled_one">
					<!--表格-->
                    <table id="tableProjectProfitList"></table>
                    <!--底部翻页按钮栏 -->
		         	<div id="pagerProjectProfitList"></div>
                </div>
            </div>
        </div>

    </div>
<script type="text/javascript" src="<%=path %>/pages/finance/js/project_profit.js"></script>
</body>
</html>