                        ...
                        <div class="search-text">
                            <form class="layui-form" action="">
                                <select name="breed" lay-verify="" lay-search>
                                    ...
                                    <option value="04">优先级LP</option>
                                    <option value="05">其他（LP）</option>
                                    <option value="06">财务顾问</option>
                                </select>
                            </form>
                        </div>
                    </div>
...
<!--正文-->
        <div class="bg-white">
            <div class="bg-border">
                ...
                <div class="top_btn">
                    <a href="subject_finance_see.html" class="main_btn">
                        ...
                        <table class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th>项目名称</th><th>楼盘名称</th><th>出资类别</th><th>投资主体名称</th><th>预计出资额(万元)</th><th>持股比例(%)</th><th>实际出资(万元)</th><th>出资期数(月)</th><th>分红方式</th><th>年化利率(%)</th><th>预计总回款(万元)</th><th>已收本金(万元)</th><th>已收回报(万元)</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td><input type="checkbox" class="hook_inp"></td>
                                    <td><a href="../trade_manage/project_manage_see.html" class="table_bnt">南山项目</a></td><td>清上华居</td><td>GP</td><td>深圳市汇联基金管理有限公司</td><td>--</td><td>0</td><td>--</td><td>21</td><td>管理费</td><td>2</td><td>5,000.00 </td><td>5,000.00 </td><th>--</th>
                                </tr>
                                <tr>
                                    <td><input type="checkbox" class="hook_inp"></td>
                                    <td><a href="../trade_manage/project_manage_see.html" class="table_bnt">福田项目</a></td><td>红树湾公馆</td><td>优先级LP</td><td>汇联投资服务（深圳）有限公司</td><td>5000.00</td><td>12.5</td><td>15000.00</td><td>21</td><td>固定年化</td><td>12</td><td>25000.00 </td><td>20000.00 </td><th>--</th>
                                </tr>
                                <tr>
                                    <td><input type="checkbox" class="hook_inp"></td>
                                    <td><a href="../trade_manage/project_manage_see.html" class="table_bnt">南山项目</a></td><td>清上华居</td><td>中间级LP</td><td>深圳市融鑫资产管理有限公司</td><td>35000.00</td><td>82.5</td><td>35000.00</td><td>21</td><td>剩余利润</td><td>--</td><td>35000.00 </td><td>26000.00 </td><th>10000.00</th>
                                </tr>
                                <tr>
                                    <td><input type="checkbox" class="hook_inp"></td>
                                    <td><a href="../trade_manage/project_manage_see.html" class="table_bnt">南山项目</a></td><td>清上华居</td><td>财务顾问</td><td>前海汇联金融服务（深圳）有限公司</td><td>--</td><td>--</td><td>--</td><td>--</td><td>顾问费</td><td>8</td><td>15000.00 </td><td>--</td><th>10000.00</th>
