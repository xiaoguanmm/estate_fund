...
public class DateTimeUtils extends DateUtils {
     ...
     * @return
     */
    public static Date getAfterDay(int n,Date date) {
        Calendar c = Calendar.getInstance();
        c.setTime(date);
        c.add(Calendar.DATE, n);
        return c.getTime();
    ...
    public static String formatSecond(long second){  
        ...
        if(second > 0){  
            ...
            timeFormat= String.format(format, array);  
        }  
       return timeFormat;  
   } 
    
    public static void main(String[] args) throws Exception {
    	System.out.println(getTimeFormat(getStartPreDay(0)));
    }
}
